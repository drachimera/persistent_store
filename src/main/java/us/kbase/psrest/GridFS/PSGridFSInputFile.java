 ...
 * This is a modified version of the GridFS spec by 10gen
 */
...
*/
    PSGridFSInputFile( PSGridFS fs , InputStream in , String filename, boolean closeStreamOnPersist ) {
        _fs = fs;
        _in = in;
        _filename = filename;
...
* Name of the file to be created.
*/
    PSGridFSInputFile( PSGridFS fs , InputStream in , String filename ) {
...
* Name of the file to be created.
*/
    PSGridFSInputFile( PSGridFS fs , String filename ) {
