...
public class NonBlockingHttpHandlerSample {
        ...
        public void run() throws IOException {
            ...
            try {
                ...
                try {
                    ...
                    if (connection != null) {
                        connection.close();//.closeSilently();
                    }
                }
            } finally {
                // stop the transport
    ...
    private static class NonBlockingEchoHandler extends HttpHandler {
        ...
        public void service(final Request request,
            ...
            final NIOReader in = request.getReader(false);//.getNIOReader(); // put the stream in non-blocking mode
            final NIOWriter out = response.getWriter(false);//.getNIOWriter();
